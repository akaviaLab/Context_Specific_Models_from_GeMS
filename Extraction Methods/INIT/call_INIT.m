function tissueModel = call_INIT(model, eps_param, weights, tol, logfile, runtime)
    % Run INIT with specified parameters
    % Input:
    ...
    %  runtime - maximum solve time for the MILP (seconds)
