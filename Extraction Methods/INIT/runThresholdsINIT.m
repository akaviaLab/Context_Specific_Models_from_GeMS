...
if strcmp(figName,'UB') || strcmp(figName,'UF')
    %UNCONSTRAINED
    epsil = 1;
    run_INIT(model,ths.p25, figName, epsil, w1, 1, modelName, tol, runtime);
    run_INIT(model,ths.p50, figName, epsil, w2, 2, modelName, tol, runtime);
    run_INIT(model,ths.p10, figName, epsil, w3, 3, modelName, tol, runtime);
    run_INIT(model,ths.mean, figName, epsil, w4, 4, modelName, tol, runtime);
end
